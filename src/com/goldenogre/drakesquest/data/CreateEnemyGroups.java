...
public class CreateEnemyGroups {
    ...
    public CreateEnemyGroups(){
        ...
        Enemy enemy_1 = new Enemy("Chaos", 2000,255,0,0,0,0,25,
                'e',false);
        Enemy enemy_2 = new Enemy("Tiamat", 1200,180,0,0,0,0,25,
                'e',false);
        Enemy enemy_3 = new Enemy("Kraken", 1000,532,0,0,0,0,25,
                'e',false);
        Enemy enemy_4 = new Enemy("Marilith", 800,500,0,0,0,0,25,
                'e',false);
        Enemy enemy_5 = new Enemy("Lich", 400,235,0,0,0,0,25,
                'e',false);
